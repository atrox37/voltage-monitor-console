...
import { extractCaptchaBase64, normalizeCaptchaSrc } from "@/lib/captcha";
...
function LoginPage() {
  ...
  const fetchCaptcha = useCallback(async () => {
    ...
    try {
      ...
      const src = normalizeCaptchaSrc(extractCaptchaBase64(res));
      if (!src) {
        setCaptchaImage("");
        showError(t("login.captchaFailed"));
        return;
      }
      setCaptchaImage(src);
      setCaptcha("");
    ...
    <div className="relative min-h-screen overflow-hidden bg-[var(--background)]">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-6 py-12">
        <div className="w-full max-w-lg">
          ...
          <Card variant="borderless" className="!px-2">
            ...
            <Typography.Text
              type="secondary"
              className="mt-6 block border-t border-[var(--panel-border)] pt-4 text-center text-[11px]"
            >
